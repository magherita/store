...
namespace Application.Services.Products
{
    public interface IProductService
    {
        Task<ProductModel> AddProductAsync(
            AddProductModel model, CancellationToken cancellationToken = default);
        ...
        Task<List<ProductModel>> GetProductListAsync(CancellationToken cancellationToken = default);
    }
}
